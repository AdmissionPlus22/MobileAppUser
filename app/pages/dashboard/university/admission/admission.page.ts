...
export class AdmissionPage implements OnInit {
  ...
  constructor(private router: Router,
    ...
    this.StreamId = this.activatedRoute.snapshot.paramMap.get('myid1');
  ...
  async Save() {
    ...
    if ((this.ApplicantName == '' || this.ApplicantName == null) ||
      ...
      this.restApiService.InsertUniversityAdmission(dataToSend).subscribe(dataReturnFromService => {
        ...
        if (dataReturnFromService == "Not Submitted") {
          ...
          this.router.navigate(['/universityadmissiondoc1/' + this.ApplicationId]);
